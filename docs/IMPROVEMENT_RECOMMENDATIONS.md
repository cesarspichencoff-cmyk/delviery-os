...
| U1b | **Caixa** é célula operacional derivada, não praça | Leitura parcial explicável em modo sombra — ver [CAIXA_OPERATIONAL_MODEL](copiloto/CAIXA_OPERATIONAL_MODEL.md); **não** remover, **não** hardcodar; **sem "Sobrecarregado"** só com `p` | Célula viva e honesta; capta pressão da etapa final | Médio (nova leitura) | Decisão de produto | **Decisão César** |
| U1d | **Conferência** é célula DISTINTA do Caixa e hoje sem fonte própria comprovada | Definir fonte própria (início/fim de conferência, itens pendentes, checklist, tempo em conferência). **Não** alimentar com `montagem_outros` só para preencher | Conferência deixa de ser rótulo sem lastro | Médio | Decisão de produto | **Decisão César** |
