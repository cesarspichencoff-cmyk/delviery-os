...
module.exports={
  ...
  ...require('./migration'),...require('./public-information'),...require('./engine'),...require('./engine-factory'),...require('./response-composer'),...require('./conversational-composer'),...require('./runtime'),...require('./simulator')
};
